...
package com.ys.webservice.client;
 ...
 * 
 */
@WebServiceClient(name = "UserService", targetNamespace = "http://WebService.ys.com/client", wsdlLocation = "http://localhost:9527/UserService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICE_QNAME = new QName("http://WebService.ys.com/client", "UserService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9527/UserService?wsdl");
    ...
    public User getUserPort() {
        return super.getPort(new QName("http://WebService.ys.com/client", "UserPort"), User.class);
    }
    ...
    public User getUserPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://WebService.ys.com/client", "UserPort"), User.class, features);
    }
